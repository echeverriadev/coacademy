              ...
              <div className="container">
                <div className="page-header">
                  ...
                  <ol className="breadcrumb">
                    ...
                    <li className="breadcrumb-item">
                      <strong>
                        <Link to="/courses">Cursos disponibles</Link>
                      </strong>
                    </li>
                        ...
                        <div className="item-det mb-4">
                            ...
                            <h3 className="font-weight-semibold">
                              ...
                              parseInt(course.is_in_offer) === 2 ? (
                                ...
                                parseInt(course.is_in_offer, 10) === 1 && (
                                  <label style={{ float: "right" }}>
                                    <span class="text-dark font-weight-semibold h2">
                                      {course.offer_price}$
                                    </span>
                          ...
                          <div className=" d-flex">
                            <ul className="d-flex mb-0">
                              ...
                              <li className="mr-5">
                                <a href="/" className="icons">
                                  <i className="icon icon-people text-muted mr-1"></i>{" "}
                                  765 Enrolled
                                </a>
                              </li>
                            </ul>
                        ...
                        <div className="mb-4 description">
                          ...
                          {course.document_description && (
                            <a
                              ...
                              className="btn btn-warning icons"
                            >
                              <i className="icon icon-printer  mr-1"></i>{" "}
                              Descargar documento
                            </a>
                          )}
                        </div>
                          ...
                          <div className="row">
                            <div className="col-xl-6 col-md-12">
                              <ul className="list-unstyled widget-spec mb-0">
                                <li className="">
                                  <i className="fa fa-calendar-check-o text-muted w-5"></i>
                                  {getFullDateNoHours(course.begin_date)}
                                </li>
                                <li className="">
                                  <i className="fa fa-calendar-times-o text-muted w-5"></i>
                            ...
                            <div className="col-xl-6 col-md-12">
                              <ul className="list-unstyled widget-spec mb-0">
                                <li className="">
                                  <i className="fa fa-clock-o  text-muted w-5"></i>{" "}
                                  {course.modality.name}
                                </li>
                                {course.document_description && (
                                  <li className="">
                                    <i className="fa fa-file-pdf-o  text-muted w-5"></i>{" "}
                                    Descripción disponible en PDF
                                  </li>
                                )}
                              </ul>
                            </div>
                          ...
                          <div className="row">
                            ...
                            !userHasNoInscribe(userCourses, course) ? (
                              <Link
                                ...
                                onClick={() => onSendBuyRequest(user, course)}
                            ...
                            <div className="mb-3 mb-xl-0">
                              <FacebookShareButton
                                url={
                                  "https://colab-course-web.herokuapp.com/courseDetails/" +
                                  course.id
                                }
                                quote={course.name}
                              >
                    ...
                    <div className="card mb-0">
                      ...
                      <div className="card-body  item-user">
                        <div className="profile-pic mb-0">
                          <img
                            src="../assets/images/users/female/25.jpg"
                            ...
                            courses.slice(0, 5).map(
                              (course_mapped) =>
                                course_mapped.id !== course.id && (
                                  <Link
                                    to={"/courseDetails/" + course_mapped.id}
                                    className="btn-link"
                                  >
