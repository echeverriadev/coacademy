				...
				<section className="sptb banner-1 cover-image  bg-background2 flipthis-highlight">
					<div className="container">
	                  ...
	                  />
									...
									<div className="card-body text-center bg-admin-custom item-user border-bottom">
										<div className="profile-pic">
											<div className="profile-pic-img">
												<img src={require("../image/25.jpg")} className="brround" alt="user" />
											</div>
											<a href="userprofile.html" className="text-dark"><h4 className="mt-3 mb-0 font-weight-semibold">Jacob Smith</h4></a>
										</div>
									</div>
									<div className="item1-links  mb-0">
										<Link to="/userProfile" className="active d-flex border-bottom">
											<span className="icon1 mr-3"><i className="icon icon-user"></i></span> Perfil de usuario
										</Link>
										<Link to="/courses" className=" d-flex  border-bottom">
											<span className="icon1 mr-3"><i className="icon icon-list"></i></span> Lista de cursos
										</Link>
										<a href="myfavorite.html" className=" d-flex border-bottom">
											<span className="icon1 mr-3"><i className="icon icon-heart"></i></span> Cursos mas destacados
										</a>
										<a href="manged.html" className="d-flex  border-bottom">
											<span className="icon1 mr-3"><i className="icon icon-folder-alt"></i></span> Managed Courses
										</a>
										<a href="payments.html" className=" d-flex  border-bottom">
											<span className="icon1 mr-3"><i className="icon icon-credit-card"></i></span> Pagos
										</a>
										<a href="orders.html" className="d-flex  border-bottom">
											<span className="icon1 mr-3"><i className="icon icon-basket"></i></span> Ordenes de cursos
										</a>
										...
										<a href="/" className="d-flex" onClick={() => onLogout() }>
											<span className="icon1 mr-3"><i className="icon icon-power"></i></span> Cerrar sesión
										</a>
									</div>
								</div>
				        ...
				        <Switch>
				            <Route exact path="/userProfile" component={ UserProfileEditable }></Route>
