                ...
                <div className="card-body">
                    ...
                    <ul className="usertab-list mb-0">
                      ...
                      <li>
                        <label className="text-dark">
                          ...
                          <span className="text-muted">
                            {user && user.user_profile && user.user_profile.sex
                              ? user.user_profile.sexAsString
                              : "No posee"}
                          </span>
                        </label>
                      </li>
                      <li>
                        <label className="text-dark">
                          ...
                          <span className="text-muted">
                            {user && user.user_profile && user.user_profile.role
                      ...
                      {user &&
                        ...
                        user.user_profile.role.name === "Profesor " && (
                          <li style={{ width: "100%" }}>
                            <label className="text-dark">
                              <span className="font-weight-semibold">
                                Biografía:
                  ...
                  <div className="row" style={{ float: "left" }}>
                    ...
                    {user.status === 1 ? (
                      ...
                      <button
                        onClick={() => onReactivateUserClick(user.id)}
