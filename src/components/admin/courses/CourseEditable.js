...
class CourseEditable extends React.Component {
    ...
    return(
      <div className="card mb-0">
        ...
        <div className="card-header">
          <h3 className="card-title">Modificar detalles del curso</h3>
        </div>
          ...
          <div className="p-2 border mb-4 form-group">
            ...
            <form>
              <input
                ...
                onChange={(e) => onUploadImageChange(course, e)}
              />
            </form>
          </div>
          {course &&
          ...
          <div className="form-group">
            ...
            <label style={{padding: 5}} className="form-control"> 
              <input
                ...
                type="radio"
                name="is_important"
                checked={String(course.is_important) === "1"}
                defaultValue="1"
                onChange={onHandleEditInputChange}
              /> Destacado 
              <input
                ...
                type="radio"
                name="is_important"
                checked={String(course.is_important) === "2"}
                defaultValue="2"
                onChange={onHandleEditInputChange}
              /> Común 
            </label>
