                    ...
                    <div className="row">
                      <div className="col-lg-12 col-md-12">
                        <div className="wideget-user-desc text-center">
                          ...
                          <div
                            className="user-wrap wideget-user-info"
                            style={{ marginTop: "0.5rem" }}
                          >
                            <label
                              style={{ cursor: "pointer" }}
                              className="m-t-10 text-white"
                          ...
                          <div className="wideget-user-icons mt-2">
                            {user &&
                              ...
                              user.user_profile.facebook && (
                                <a
                                  href={`https://www.facebook.com/${user.user_profile.facebook}`}
                                  target="_blank"
                            ...
                            {user &&
                              user.user_profile &&
                              user.user_profile.twitter && (
                                <a
                                  href={`https://www.twitter.com/${user.user_profile.twitter}`}
                                  target="_blank"
                                  rel="noopener noreferrer"
                                  style={{ marginRight: 5 }}
                            ...
                            {user &&
                              user.user_profile &&
                              user.user_profile.instagram && (
                                <a
                                  href={`https://www.instagram.com/${user.user_profile.instagram}`}
                                  target="_blank"
                                  rel="noopener noreferrer"
                                  style={{ marginRight: 5 }}
                                  className="instagram"
                            ...
                            {user &&
                              user.user_profile &&
                              user.user_profile.linkedin && (
                                <a
                                  href={`https://www.linkedin.com/in/${user.user_profile.linkedin}`}
                                  target="_blank"
                                  rel="noopener noreferrer"
                                  className="linkedin"
                                >
                    ...
                    <div className="tab-menu-heading">
                      <div className="tabs-menu1">
                        <ul className="nav">
                          ...
                          <li>
                            <a href="#tab-7" data-toggle="tab" className="">
                              Cambiar contraseña
                            </a>
                          </li>
                        </ul>
