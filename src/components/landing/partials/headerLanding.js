    ...
    render(){
      ...
      return (
        <div>
          <div
            className={
              (kindOfMenu && kindOfMenu === 'INDEX')? "banner-1 cover-image  bg-background2 background-photo"
              :
              "cover-image bg-background3 background-photo"
            }
            data-image-src={(kindOfMenu && kindOfMenu === 'INDEX')? "../assets/images/banners/elearning.jpg" : "../assets/images/banners/banner2.jpg"}
          >
            <Menu changeMenu={changeMenu} kindOfMenu={kindOfMenu} user={user} onLogout={onLogout} />

            {
              ...
              (kindOfMenu && kindOfMenu === 'COURSE_LIST')?
                        ...
                        <div className="row">
                          <div className="col-xl-9 col-lg-12 col-md-12 d-block mx-auto">
                            <div className="text-center text-white text-property">
                              <h1 className="">
                                <span className="font-weight-bold">2000+</span> cursos
                                disponibles aquí!
                              </h1>
                            </div>
                            <div className="search-background bg-transparent">
                              <div className="form row no-gutters ">
                                <div className="form-group  col-xl-7 col-lg-3 col-md-12 mb-0 bg-white">
                                  <input
                                ...
                                <div className="form-group col-xl-3 col-lg-3 col-md-12 select2-lg  mb-0 bg-white">
                                  ...
                                  >
                                    <option key={null} value={"-1"}>Todas las categorías</option>
                                    {
                ...
                (kindOfMenu && kindOfMenu === 'INDEX')?
                                  ...
                                  <div className="form-group col-xl-3 col-lg-3 col-md-12 select2-lg  mb-0 bg-white">
                                    ...
                                    >
                                      <optgroup label="Categorías">
                                        <option key={-1} value={"-1"}>Todas las categorías</option>
                                        {
                                          (categories && categories.length > 0)&&
                                            categories.map((category) => (
                                              <option key={category.id} value={category.id}>{category.name}</option>
                    ...
                    <section>
                      <div className="bannerimg">
                        <div className="header-text mb-0">
                          <div className="container">
                            <div className="text-center text-white ">
                              <h1 className="">Ingresa tu email y te enviaremos una nueva contraseña.</h1>
                              <ol className="breadcrumb text-center">
                                <li className="breadcrumb-item"><Link to="/">Inicio</Link></li>
                                <li className="breadcrumb-item active text-white" aria-current="page">Recupera tu contraseña</li>
                              </ol>
                            </div>
                          </div>
                        </div>
                  ...
                  :
                  (kindOfMenu && kindOfMenu === 'MY_PROFILE')&&
                  <div>
                    <section>
                      <div className="bannerimg">
                        <div className="header-text mb-0">
                          <div className="container">
                            <div className="text-center text-white ">
                              ...
                              <ol className="breadcrumb text-center">
                                <li className="breadcrumb-item"><Link to="/">Inicio</Link></li>
                                <li className="breadcrumb-item active text-white" aria-current="page">Perfil del Usuario</li>
                              </ol>
                            </div>
                          </div>
                        </div>
