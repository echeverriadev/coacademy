    ...
    render(){
        ...
        return (
            <div>
                <section className="sptb">
                    <div className="container">
                        <div className="text-justify">
                            ...
                            <h5 className="leading-normal">Majority have suffered alteration in some form, by injected humor</h5>
                            <p className="leading-normal text-muted">There are many variations of passages of Lorem Ipsum available, but the majority have suffered  by injected humour, or randomised words which don't look even slightly believable.
                                ...
                                <div className="">
                                    <div className="mb-sm-0 mb-4">
                                        <div className="service-card text-center">
                                            ...
                                            <div className="servic-data mt-3">
                                                <h4 className="font-weight-semibold mb-2">Coursed Posts</h4>
                                                <p className="text-muted mb-0">Nam libero tempore, cum soluta nobis est eligendi cumque facere possimus</p>
                                            </div>
                                        </div>
                                    </div>
                ...
                <section>
                    <div className="cover-image about-widget sptb bg-background-color" data-image-src="../assets/images/banners/banner4.jpg">
                        <div className="content-text mb-0">
                            <div className="container">
                                <div className="text-center text-white ">
                                    <h2 className="mb-2 font-weight-400">Let's Update Your Skills with Our Training Professionals...</h2>
                                    <p>It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout.</p>
                                    <div className="mt-5">
                                        <Link to="/login" onClick={() => {this.registerClick(); changeMenu('REGISTER')}} className="btn btn-lg btn-primary">Registrate ahora!</Link>
                                    </div>
                                </div>
                            </div>
                        </div>
