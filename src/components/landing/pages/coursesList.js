                        ...
                        <div className="">
                          <div className="p-5 bg-white item2-gl-nav d-flex">
                            <h6 className="mb-0 mt-2">
                              Tenemos disponibles {courses.length} cursos
                                    ...
                                    <div className="card-body ">
                                      <div className="item-card9">
                                        <Link
                                          ...
                                          className="text-dark"
                                        >
                                          <h3 className="font-weight-semibold mt-1">
                                            {course.name}
                                          </h3>
                                        </Link>
                                        <div className="mt-2 mb-2">
                                          ...
                                          >
                                            <span className="text-muted fs-13">
                                              <i className="fa fa-user-o text-muted mr-1"></i>{" "}
                                              {course.provider.name}
                                            </span>
                                          </Link>
                                          {course &&
                                            parseInt(course.with_date, 10) ===
                                              1 && (
                                              <Link
                                                to={
                                  ...
                                  <div className="card overflow-hidden">
                                    ...
                                    <div className="card-body2">
                                      <div className="item-card9">
                                        ...
                                        >
                                          <h3 className="font-weight-semibold mt-1 mb-3">
                                            {course.name}
                                          </h3>
                                        </Link>
                                        ...
                                        <div className="item-card9-cost">
                                          ...
                                          parseInt(course.is_in_offer) === 2 ? (
                                            ...
                                            parseInt(course.is_in_offer, 10) ===
                                              1 && (
                                              <label>
                                                <span class="text-dark font-weight-semibold h4">
                                                  {course.offer_price}$
                                                </span>
                                                <span className="text-muted h5 font-weight-normal ml-1">
                                                  <span className="strike-text">
                                ...
                                coursesByCategories.length > 0 && (
                                  <span className="custom-control-label">
                                    <span className="text-dark">
                                      {category.name}
                                      <span className="label label-secondary float-right">
                                        {coursesByCategories[index] &&
                  ...
                  <div className="card-body">
                    <div className="filter-product-checkboxs">
                      {modalities && modalities.length > 0 ? (
                        modalities.map((modality, index) => (
                          ...
                          >
                            <input
                              ...
                              value={modality.id}
                              checked={
                                parseInt(filter_modality, 10) ===
                                parseInt(modality.id)
                              }
                              onChange={(e) => {
                                changeCourseFilter(e);
                                filterCourses();
                        ...
                        <span className="">
                          <span className="text-dark">
                            No existen modalidades disponibles
                          </span>
                        </span>
                      )}
                    </div>
